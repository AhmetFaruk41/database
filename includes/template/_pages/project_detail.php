...
<div class="page-headers-main">
    <div class="page-headers-main-in">
        <div class="page-headers-main-left font-raleway font-18 font-small font-spacing" style="color:#<?php echo $pagehead['text_color'] ?>;">
            ...
            <?php echo ucwords_tr($proje['baslik']) ?>
            ...
            <a href="projeler" style="color:#<?php echo $pagehead['text_color'] ?>;"><span style="padding-right: 15px; color:#<?php echo $pagehead['text_color'] ?>;"><?php echo ucwords_tr($diller['proje']) ?></span></a>
        </div>
    </div>
</div>
<!-- Page Header ====================== !-->
