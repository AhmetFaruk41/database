...
<head>
    ...
    <title>Fırın</title>
    <link href="../../../fonts.googleapis.com/css2367.css?family=Cairo:400,600,700&amp;display=swap" rel="stylesheet">
    <link href="../../../fonts.googleapis.com/cssce04.css?family=Poppins:600&amp;display=swap" rel="stylesheet">
    <link href="../../../fonts.googleapis.com/css6259.css?family=Playfair+Display:400i,700i" rel="stylesheet">
    <link href="../../../fonts.googleapis.com/css9036.css?family=Ubuntu&amp;display=swap" rel="stylesheet">
            ...
            <div class="container">
                <div class="top-bar left">
                    <ul class="horizontal-menu">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>info@firin.com</a></li>
                        <li><a href="#">Ücretsiz Ulaşım</a></li>
                    </ul>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="index.php" class="biolife-logo"><img src="assets/images/logo.png" alt="logo" width="135" height="36"></a>
                    </div>
                    <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                        <div class="primary-menu">
                            <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                                <li class="menu-item"><a href="index.php">Anasayfa</a></li>
                                <li class="menu-item"><a href="about.php">Kurumsal</a></li>
                                <li class="menu-item menu-item-has-children has-megamenu">
                                    <a href="#" class="menu-name" data-title="Shop" >Ürünler</a>
                                        ...
                                        <div class="mega-content">
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    <h4 class="menu-title">Kategori</h4>
                                                    <ul class="menu">
                                                        <li><a href="#">Tür</a></li>
                                                        <li><a href="#">Tür</a></li>
                                                        <li><a href="#">Tür</a></li>
                                ...
                                <li class="menu-item"><a href="index.php">Bayilik</a></li>
                                ...
                                <div class="minicart-contain">
                                    ...
                                    <div class="cart-content">
                                        <div class="cart-inner">
                                            <ul class="products">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="https://www.teksinun.com/wp-content/uploads/2018/08/ekmek-un.jpg-347x231.png" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">Ekmek</a></div>
                                                            <div class="price">
                                                                <ins><span class="price-amount"><span class="currencySymbol">₺</span>5.00</span></ins>
                                                                <!-- <del><span class="price-amount"><span class="currencySymbol">£</span>95.00</span></del> -->
                                                            </div>
                                                            <div class="qty">
                                                                <label for="cart[id123][qty]">Adet:</label>
                                            ...
                                            <p class="btn-control">
                                                <a href="#" class="btn view-cart">Sepete Bak</a>
                                                <a href="#" class="btn">Ödeme</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wrap-menu">
                                    <ul class="menu clone-main-menu">
                                        <li class="menu-item menu-item-has-children has-child">
                                            <a href="#" class="menu-name" data-title="Ekmek"><img src="assets/images/upload/bread.png" alt="" width="24" height="24" style="margin-right:5px">Ekmekler</a>
                                            <ul class="sub-menu">
                                                <li><a href="#">Kepek</a></li>
                                                <li><a href="#">Somon</a></li>
                                                <li><a href="#">Tuzsuz</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item menu-item-has-children has-child">
                                            <a href="#" class="menu-name" data-title="Kap Kekler"><img src="assets/images/upload/cupcake.png" alt="" width="24" height="24" style="margin-right:5px">Kap Kekler</a>
                                            <ul class="sub-menu">
                                                <li><a href="#">Çikolatalı</a></li>
                                                <li><a href="#">Meyveli</a></li>
                                                <li><a href="#">Çilekli</a></li>
                                                <li><a href="#">Muzlu</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item menu-item-has-children has-child">
                                            <a href="#"  class="menu-name"><img src="assets/images/upload/cake.png" alt="" width="24" height="24" style="margin-right:5px">Pastalar</a>
                                            <ul class="sub-menu">
                                                <li><a href="#">Muzlu</a></li>
                                                <li><a href="#">Franbuazlı</a></li>
                                                <li><a href="#">Çikolatalı</a></li>
                                                <li><a href="#">Çilekli</a></li>
                                                <li><a href="#">Kivili</a></li>
                                                <li><a href="#">Karışık Meyveli</a></li>
                                                <li><a href="#">Çikolata & Vanilyalı</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item menu-item-has-children has-child">
                                            <a href="#" class="menu-name"><img src="assets/images/upload/cookie.png" alt="" width="24" height="24" style="margin-right:5px">Kurabiyeler</a>
                                            <ul class="sub-menu">
                                                <li><a href="#">Çikolata Parçacıklı</a></li>
                                                <li><a href="#">Bitter Çikolata Parçaçıklı</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item menu-item-has-children has-child">
                                            <a href="#" class="menu-name" data-title="Ekmek"><img src="assets/images/upload/bread.png" alt="" width="24" height="24" style="margin-right:5px">Ekmekler</a>
                        ...
                        <div class="main-slide block-slider nav-change hover-main-color type02">
                            <ul class="biolife-carousel" data-slick='{"arrows": true, "dots": false, "slidesMargin": 0, "slidesToShow": 1, "infinite": true, "speed": 800}' >
                                ...
                                <li>
                                    ...
                                    <img src="assets/images/upload/slider1.jpg" alt="">
                                        <div class="text-content">
                                            <i class="first-line">Öne Çıkan</i>
                                            <h3 class="second-line">En İyi Lezzet</h3>
                                            <p class="third-line">Ürün hakkında açıklayıcı bilgi</p>
                                            <p class="buttons">
                                                <a href="#" class="btn btn-bold">Sepete Ekle</a>
                                                <a href="#" class="btn btn-thin">İncele</a>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="slide-contain slider-opt04__layout01 light-version first-slide">
                                    <img src="assets/images/upload/slider2.jpg" alt="">
                                        <div class="text-content">
                                            <i class="first-line">Öne Çıkan</i>
                                            <h3 class="second-line">En İyi Lezzet</h3>
                                            <p class="third-line">Ürün hakkında açıklayıcı bilgi</p>
                    ...
                    <ul class="biolife-carousel nav-center-bold nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":3, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 3}},{"breakpoint":992, "settings":{ "slidesToShow": 2}},{"breakpoint":768, "settings":{ "slidesToShow": 2}}, {"breakpoint":500, "settings":{ "slidesToShow": 1}}]}'>
                        <li>
                            <div class="biolife-banner biolife-banner__style-08">
                                <div class="banner-contain">
                                    <div class="media">
                                        <a href="#" class="bn-link"><img src="assets/images/upload/cookieS.png" width="193" height="185" alt=""></a>
                                    </div>
                                    <div class="text-content">
                                        <span class="text1">Kurabiyeler</span>
                                        <b class="text2">Çeşit Çeşit Kurabiye</b>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="biolife-banner biolife-banner__style-08">
                                <div class="banner-contain">
                                    <div class="media">
                                        <a href="#" class="bn-link"><img src="assets/images/upload/cupcakeS.png" width="191" height="185" alt=""></a>
                                    </div>
                                    <div class="text-content">
                                        <span class="text1">Kap Kekler</span>
                                        <b class="text2">Çeşit Çeşit Kap kek</b>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="biolife-banner biolife-banner__style-08">
                                <div class="banner-contain">
                                    <div class="media">
                                        <a href="#" class="bn-link"><img src="assets/images/upload/cakeS.png" width="185" height="185" alt=""></a>
                                    </div>
                                    <div class="text-content">
                                        <span class="text1">Pastalar</span>
                                        <b class="text2">Çeşit Çeşit Pasta</b>
                                    </div>
                                </div>
                            </div>
                        </li>
            ...
            <div class="wrap-category xs-margin-top-80px">
                <div class="container">
                    <div class="biolife-title-box style-02 xs-margin-bottom-33px">
                        ...
                        <h3 class="main-title">En Çok Tercih Edilenler</h3>
                        <p class="desc">Mahmüllerimiz Arasında en çok talep gören ürünlerimiz</p>
                    </div>
                            ...
                            <div class="biolife-cat-box-item">
                                <div class="cat-thumb">
                                    <a href="#" class="cat-link">
                                        <img src="assets/images/upload/makaron.png" style="width:277px;height:185px;object-fit:contain;" alt="">
                                    </a>
                                </div>
                                <a class="cat-info" href="#">
                                    <h4 class="cat-name">Makaron</h4>
                                    <span class="cat-number">(20 Adet)</span>
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="biolife-cat-box-item">
                                <div class="cat-thumb">
                                    <a href="#" class="cat-link">
                                        <img src="assets/images/upload/cookie2.png" style="width:277px;height:185px;object-fit:contain;" alt="">
                                    </a>
                                </div>
                                <a class="cat-info" href="#">
                                    <h4 class="cat-name">Spesyal Kurabiye</h4>
                                    <span class="cat-number">(10 Adet)</span>
                                </a>
                            </div>
                        </li>
                         <li>
                            <div class="biolife-cat-box-item">
                                <div class="cat-thumb">
                                    <a href="#" class="cat-link">
                                        <img src="assets/images/upload/cake2.png" style="width:277px;height:185px;object-fit:contain;" alt="">
                                    </a>
                                </div>
                                <a class="cat-info" href="#">
                                    <h4 class="cat-name">Dilim Pasta</h4>
                                    <span class="cat-number">(1 Dilim)</span>
                                </a>
                            </div>
                        </li>
                         <li>
                            <div class="biolife-cat-box-item">
                                <div class="cat-thumb">
                                    <a href="#" class="cat-link">
                                        <img src="assets/images/upload/cake3.png" style="width:277px;height:185px;object-fit:contain;" alt="">
                                    </a>
                                </div>
                                <a class="cat-info" href="#">
                                    <h4 class="cat-name">Dilim Pasta (Monolatte)</h4>
                                    <span class="cat-number">(1 Dilim)</span>
                                </a>
                            </div>
                        </li>
                         <li>
                            <div class="biolife-cat-box-item">
                                <div class="cat-thumb">
                                    <a href="#" class="cat-link">
                                        <img src="assets/images/upload/bread2.png" style="width:277px;height:185px;object-fit:contain;" alt="">
                                    </a>
                                </div>
                                <a class="cat-info" href="#">
                                    <h4 class="cat-name">Tuzsuz Ekmek</h4>
                                    <span class="cat-number">(1 Adet)</span>
                                </a>
                            </div>
                        </li>
                        ...
                        <ul class="services-list">
                            <li>
                                <div class="service-inner color-reverse">
                                    ...
                                    <a class="srv-name" href="#">Ürünler Steril Paketlenir</a>
                                </div>
                            </li>
                            <li>
                                <div class="service-inner color-reverse">
                                    ...
                                    <a class="srv-name" href="#">Zamanlı Çalışılır</a>
                                </div>
                            </li>
                            <li>
                                <div class="service-inner color-reverse">
                                    ...
                                    <a class="srv-name" href="#">Gün İçinde Adrese Teslim Edilir</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="product-tab z-index-20 sm-margin-top-59px xs-margin-top-20px">
                <div class="container">
                    <div class="biolife-title-box slim-item">
                        <span class="subtitle">En iyiler sizin için</span>
                        ...
                        <div class="tab-head tab-head__sample-layout">
                            <ul class="tabs">
                                <li class="tab-element active">
                                    <a href="#tab01_1st" class="tab-link">En Yeni</a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_2nd" class="tab-link">En Çok Satan</a>
                                </li>
                                <li class="tab-element" >
                                    <a href="#tab01_3rd" class="tab-link">Satışta olan</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":1 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2,"rows":2, "slidesMargin":15 }}]}'>
                                        ...
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="assets/images/upload/makaron.png" alt="Vegetables" style="width:270px;height:270px;object-fit: contain" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                                <b class="categories">Makaron</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">En Çok Tercih Edilen Ürünümüz</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">₺</span>25</span></ins>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Paket içerisinde 20 adet makaron bulunmaktadır</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Sepete Ekle</a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="assets/images/upload/bread2.png" alt="Vegetables" style="width:270px;height:270px;object-fit: contain" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                                <b class="categories">Ekmek</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">En Çok Tercih Edilen Ürünümüz</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">₺</span>25</span></ins>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Tuzlu Ekmek</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Sepete Ekle</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="assets/images/upload/cookie2.png" alt="Vegetables" style="width:270px;height:270px;object-fit: contain" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                                <b class="categories">Kurabiye</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">En Çok Tercih Edilen Ürünümüz</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">₺</span>25</span></ins>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Özel Kurabiyemiz</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Sepete Ekle</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="assets/images/upload/cake3.png" alt="Vegetables" style="width:270px;height:270px;object-fit: contain" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                                <b class="categories">Pasta</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">En Çok Tercih Edilen Ürünümüz</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">₺</span>25</span></ins>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">Monolatte Dilim Pasta</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Sepete Ekle</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                ...
                                <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":1 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2,"rows":2, "slidesMargin":15 }}]}'>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="assets/images/upload/cake2.png" alt="Vegetables" style="width:270px;height:270px;object-fit: contain" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                    ...
                    <ul class="biolife-carousel nav-center-bold nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3}},{"breakpoint":768, "settings":{ "slidesToShow": 2}}, {"breakpoint":650, "settings":{ "slidesToShow": 1}}]}'>
                        <li>
                            <div class="biolife-brd-container">
                                <a href="#" class="link">
                                    <figure><img src="https://yasamedya.com/logo/logo-blue-black.png" width="214" height="163" alt=""></figure>
                                </a>
                            </div>
                        </li>
                          <li>
            ...
            <div class="blog-posts xs-margin-top-80px sm-margin-top-61px sm-padding-top-54px xs-padding-bottom-50px">
                <div class="container">
                    <div class="biolife-title-box link-all">
                        <h3 class="main-title">Yazılarımız</h3>
                        <a href="#" class="blog-link">Tümünü Gör</a>
                    </div>
                    <ul class="biolife-carousel nav-center xs-margin-top-33px nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":3, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 3}},{"breakpoint":992, "settings":{ "slidesToShow": 2}},{"breakpoint":768, "settings":{ "slidesToShow": 2}},{"breakpoint":600, "settings":{ "slidesToShow": 1}}]}'>
                        <li>
                            <div class="post-item style-bottom-info layout-02 ">
                                <div class="thumbnail">
                                    <a href="#" class="link-to-post"><img src="https://www.teksinun.com/wp-content/uploads/2018/08/ekmek-un.jpg-347x231.png" width="370" height="270" alt=""></a>
                                    <div class="post-date">
                                ...
                                <div class="post-content">
                                    <h4 class="post-name"><a href="#" class="linktopost">Ekmek Gramajları</a></h4>
                                    <div class="post-meta">
                                    ...
                                    <div class="group-buttons">
                                        <a href="#" class="btn readmore">Devamını Oku</a>
                                    </div>
                                </div>
                            </div>
                        </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="index.php" class="logo footer-logo"><img src="assets/images/logo.png" alt="biolife logo" width="135" height="36"></a>
                            <div class="footer-phone-info">
                                <i class="biolife-icon icon-head-phone"></i>
                                <p class="r-info">
                                    <span>Bize Ulaşın</span>
                                    <span>(0262) 500 00 00  </span>
                                </p>
                            </div>
                            <div class="newsletter-block layout-01">
                                ...
                                <div class="form-content">
                                    <form action="#" name="new-letter-foter">
                                        ...
                                        <button type="submit" class="bnt-submit" name="ok">Kayıt Ol</button>
                                    </form>
                                </div>
                            </div>
                        </section>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 md-margin-top-5px sm-margin-top-50px xs-margin-top-40px">
                        <section class="footer-item">
                            <h3 class="section-title">Ulaştırma Bilgileri</h3>
                            <div class="contact-info-block footer-layout xs-padding-top-10px">
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-location"></i>
                                            <b class="desc">Adres </b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-phone"></i>
                                            <b class="desc">Telefon </b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">E-Posta:  contact@company.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-clock"></i>
                                            <b class="desc">Çalışma Saatleri</b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="copy-right-text"><p>Copyright © 2020 <b>All rights reserved</b></p></div>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from kute-themes.com/html/biolife/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Apr 2020 14:01:59 GMT -->
</html>