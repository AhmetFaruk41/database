        ...
        <div class="container">
            ...
            <div id="main-content" class="main-content">
                ...
                <div class="sumary-product single-layout">
                    <div class="media">
                        <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="500" height="500"></li>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="500" height="500"></li>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="500" height="500"></li>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="500" height="500"></li>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="500" height="500"></li>
                        ...
                        <ul class="biolife-carousel slider-nav" data-slick='{"arrows":false,"dots":false,"centerMode":false,"focusOnSelect":true,"slidesMargin":10,"slidesToShow":4,"slidesToScroll":1,"asNavFor":".slider-for"}'>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="88" height="88"></li>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="88" height="88"></li>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="88" height="88"></li>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="88" height="88"></li>
                            <li><img src="assets/images/upload/bread2.png" alt="" width="88" height="88"></li>
                    ...
                    <div class="product-attribute">
                        ...
                        <div class="price">
                            <ins><span class="price-amount"><span class="currencySymbol">₺</span>5</span></ins>
                        </div>
                    </div>
                ...
                <div class="product-tabs single-layout biolife-tab-contain">
                    <div class="tab-head">
                        <ul class="tabs">
                            <li class="tab-element active"><a href="#tab_1st" class="tab-link">Açıklama</a></li>
                            <li class="tab-element" ><a href="#tab_2nd" class="tab-link">Ek Bilgiler</a></li>
                            <!-- <li class="tab-element" ><a href="#tab_3rd" class="tab-link">Shipping & Delivery</a></li> -->
                            <li class="tab-element" ><a href="#tab_4th" class="tab-link">Yorumlar</a></li>
                        </ul>
                    </div>
                ...
                <div class="product-related-box single-layout">
                    <div class="biolife-title-box lg-margin-bottom-26px-im">
                        ...
                        <h3 class="main-title">Benzer Ürünler</h3>
                    </div>
                            ...
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="#" class="link-to-product">
                                        <img src="assets/images/upload/cookie2.png" alt="dd" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories">Kategorisi</b>
                                    <h4 class="product-title"><a href="#" class="pr-name">Kurabiye</a></h4>
                                    <div class="price">
                                        <ins><span class="price-amount"><span class="currencySymbol">₺</span>3</span></ins>
                                    </div>
...
<!-- Mirrored from kute-themes.com/html/biolife/single-product-simple.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Apr 2020 14:07:29 GMT -->
</html>